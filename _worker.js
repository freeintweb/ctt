...
export default {
  async fetch(request, env) {
    ...
    async function sendAdminPanel(chatId, topicId, privateChatId, messageId) {
      ...
      const buttons = [
        ...
        [
          ...
          { text: 'GitHub项目', url: 'https://github.com/freeintweb/ctt' }
        ],
        [
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/freeintweb/ctt/refs/heads/dev_lansing/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/freeintweb/ctt/refs/heads/dev_lansing/CFTeleTrans/notification.md');
