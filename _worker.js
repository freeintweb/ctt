...
export default {
  async fetch(request, env) {
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/freeintweb/ctt/refs/heads/dev/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/freeintweb/ctt/refs/heads/dev/CFTeleTrans/notification.md');
